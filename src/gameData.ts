...
export const PUZZLES = {
  ...
  FREQUENCY_TUNING: {
    question:
      "Frekuensi anomali: 7.3 Hz (setiap 7 jam). Prediksi crash time jika +30%?",
    answer: "9.49",
...
export const TOOLS = [
  {
    ...
    name: "Scan Command",
    unlock: "mission_1",
    description: "Scan file untuk metadata",
  },
  {
    id: "trace",
    name: "Trace Command",
    unlock: "mission_2",
    description: "Trace koneksi & source anomali",
  },
  {
    id: "isolate",
    name: "Isolate Command",
    unlock: "mission_3",
    description: "Isolate sistem bagian",
  },
  {
    id: "negotiate",
    name: "Negotiate Protocol",
    unlock: "mission_3",
    description: "Dialog dengan entity",
  },
];
...
export const EVENTS = [
  {
    trigger: "time_60min",
    type: "WARNING",
    message: "⚠️ ANOMALY DETECTED: Sektor 8 terinfeksi! Waktu berkurang.",
  },
  {
    trigger: "time_120min",
    type: "CRITICAL",
    message: "🚨 CRITICAL: Backup sistem OFFLINE. Pressure naik!",
  },
  {
    trigger: "wrong_password_3x",
    type: "LOCKOUT",
    message:
      "🔒 SISTEM TERKUNCI: Terlalu banyak percobaan salah. Tunggu 30 detik...",
  },
  {
    trigger: "mission_2_start",
    type: "ALERT",
    message:
      "[ALEX] Operator... ada sesuatu yg tidak beres. Aku mendengar sesuatu...",
  },
];
